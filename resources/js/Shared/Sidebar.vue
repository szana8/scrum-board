    ...
    <div class="min-h-screen grid content-between">
        ...
        <div>
            <div class="flex justify-between px-6 pb-12">
                <ul class="space-y-4 list-inside text-sm">
                    <li>
                        <side-link :href="route('web.client-credential.index')" :active="$page.component.startsWith('Settings')" class="flex space-x-2 text-gray-400 font-semibold hover:text-gray-600">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
